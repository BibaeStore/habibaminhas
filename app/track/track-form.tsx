...
export function TrackForm({ initialOrder = "" }: { initialOrder?: string }) {
  ...
  return (
    <div className="mx-auto w-full max-w-[760px] px-4 py-16 sm:px-6">
      ...
      {result && result !== "not-found" && cfg && (
        <div className="mt-8 flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center gap-3 border border-border-soft bg-ivory px-6 py-6 text-center sm:flex-row">
            ...
            <Link href="/ladies" className="ml-auto hidden shrink-0 items-center gap-1.5 text-[12px] uppercase tracking-[0.22em] text-ink hover:text-gold-dark sm:inline-flex">
      ...
      {/* Trust badges (always visible before search) */}
      {!result && (
