...
> = {
  faq: {
    ...
    faqs: [
      { q: "When will my order ship?", a: "In-stock items ship within 24 hours Monday-Saturday. Orders placed before 2pm ship same day. Weekend orders (Saturday after 2pm, Sunday) ship Monday morning. All Pakistan orders ship via PostEx courier with tracking. You'll receive an email confirmation, plus a WhatsApp update with your tracking number, as soon as your package is handed to the courier. Made-to-order or custom stitched items take 2-3 weeks for production before shipping — estimated delivery date is shown at checkout for these items." },
      ...
      { q: "How do returns and exchanges work?", a: "Returns (defective items only): Contact us within 14 days with photos and unboxing video. We arrange free PostEx pickup across Pakistan. Exchanges (size/fit): Available within 14 days for unworn items with tags attached and unboxing video. Free exchange shipping within Pakistan. IMPORTANT REQUIREMENT: You must record an unboxing video when opening your package for the first time. All return and exchange claims require this video as proof of product condition upon arrival. Without the unboxing video, we cannot process your claim. This protects both customers and us from disputes. See our full Returns Policy for complete details and step-by-step instructions." },
  ...
  returns: {
    ...
    faqs: [
      { q: "What is your return policy?", a: "We accept returns for defective or damaged products only. If you receive an item with manufacturing defects, stitching issues, color discrepancies, or shipping damage, contact us within 14 days of delivery. IMPORTANT: You must record an unboxing video when opening your package for the first time. Claims for defective or damaged items will ONLY be processed if accompanied by an unboxing video showing the issue. This protects both you and us by documenting the condition upon arrival. Returns for verified defective items are free — we'll arrange pickup at no cost to you across Pakistan via PostEx courier service." },
      { q: "What is your exchange policy?", a: "We accept exchanges for size, fit, or style preferences within 14 days of delivery. The item must be unworn, unwashed, and in its original packaging with all tags attached. IMPORTANT: Record an unboxing video when first opening your package. If you discover sizing or color issues upon unboxing, the video serves as proof that the item arrived in perfect condition and supports your exchange request. Exchange shipping is free within Pakistan (Karachi, Lahore, Islamabad, and all major cities) via PostEx courier." },
      { q: "Why do I need an unboxing video?", a: "The unboxing video requirement protects both customers and Habiba Minhas. For customers: it documents the exact condition of items upon arrival, proving if damage occurred during shipping or if the wrong item was sent. For us: it prevents fraudulent claims and ensures we only process legitimate defects or errors. Simply record a short video (even 30-60 seconds on your phone) showing the sealed package, opening it, and removing items. Keep the video until your return window closes (14 days, for both defects and exchanges). This policy is standard practice for Pakistani e-commerce businesses." },
      { q: "How do I start a return or exchange?", a: "Contact us via WhatsApp at +92 312 0295812 or email team@habibaminhas.com within 14 days of delivery (for defects or exchanges). Provide: (1) Your order number, (2) Photos clearly showing the issue or item, (3) Your unboxing video (mandatory — upload to Google Drive, Dropbox, or send via WhatsApp). Our team will review within 24 hours and arrange free PostEx pickup across Pakistan. For exchanges, we'll send your replacement as soon as we receive and verify your return." },
      { q: "What items cannot be returned or exchanged?", a: "The following items are non-returnable and non-exchangeable: (1) Sale items marked 'Final Sale' at checkout, (2) Intimate wear and undergarments (hygiene reasons), (3) Unstitched fabric once opened from sealed packaging, (4) Custom or made-to-order pieces (unless defective — unboxing video required), (5) Items worn, washed, altered, or with tags removed, (6) Items returned without original packaging, (7) Items past the 14-day return window (applies to both defects and exchanges). Gift purchases can be returned for store credit only within 30 days if unworn with tags attached and unboxing video provided." },
      { q: "How long does a refund or exchange take?", a: "Exchanges: Once we receive your return via PostEx (typically 2-3 days), we inspect and verify condition within 24 hours. Your replacement ships immediately via PostEx and arrives in 1-3 business days. Total timeline: 4-7 days from pickup to receiving replacement. Refunds (for defective items only): After receiving and verifying your return with unboxing video proof, refunds are processed within 24 hours. Original payment method receives refund in 5-7 business days for cards, 2-3 business days for JazzCash/Easypaisa wallets, or immediate store credit if you prefer." },
      { q: "What if I receive a defective item?", a: "We sincerely apologize if this happens. Immediately (same day if possible): (1) Record or locate your unboxing video showing the defect, (2) Take clear photos of the defect from multiple angles, (3) Contact us on WhatsApp +92 312 0295812 or email team@habibaminhas.com with your order number, photos, and unboxing video link. We'll review within 2-4 hours during business hours (Mon-Sat, 10am-6pm PKT) and arrange free PostEx pickup anywhere in Pakistan. You choose: full refund to original payment method OR replacement item shipped priority (1-2 days). If the defect was our error (manufacturing or quality control issue), we'll also include a discount code for your next order as an apology." },
  ...
  shipping: {
    ...
    intro: "Shipping times and fees, in plain numbers. All Pakistan deliveries via PostEx courier service.",
    faqs: [
      { q: "Which courier service do you use?", a: "We partner with PostEx for all Pakistan deliveries. PostEx is one of Pakistan's most reliable courier networks with coverage across all major cities (Karachi, Lahore, Islamabad, Rawalpindi, Faisalabad, Multan, Peshawar, Quetta) and over 800 cities and towns nationwide. You'll receive PostEx tracking numbers for all shipments, and PostEx offers customer support if you need delivery assistance. For international shipping, we use DHL Express for reliable worldwide delivery." },
      { q: "Pakistan — standard delivery", a: "Flat rate Rs. 250 to anywhere in Pakistan via PostEx. Delivery times: Karachi/Lahore/Islamabad 1-2 business days, other major cities 2-3 business days, smaller towns 3-4 business days. Orders placed before 2pm Monday-Friday ship same day. Weekend orders (Saturday after 2pm, Sunday) ship Monday morning. In-stock items leave our Karachi studio within 24 hours of order confirmation. During Eid, wedding season (Nov-Feb), or sales periods, add 1 extra day to delivery estimates due to high courier volume across Pakistan." },
      { q: "Pakistan — express same-day delivery", a: "Rs. 500 for same-day delivery in Karachi, Lahore, and Islamabad only (not available in other cities). Order before 2pm for same-day delivery. Your order is prepared, quality-checked, and handed to PostEx rider within 2-3 hours. Delivery typically completes by 7-9pm same day. Same-day service available Monday-Saturday only (not Sundays or public holidays). Express delivery is for in-stock items only — made-to-order or out-of-stock items ship standard timing." },
      { q: "Do you ship to all areas of Pakistan?", a: "We ship to all major cities and over 800 cities and towns served by PostEx network. This includes: all provincial capitals, divisional headquarters, tehsil headquarters, and most towns with PostEx service centres. We also ship to Azad Jammu & Kashmir and Gilgit-Baltistan, though delivery times are 5-7 business days to these regions. We do NOT ship to PO Boxes — please provide a complete street address with landmarks. If you're unsure whether we deliver to your area, contact us on WhatsApp +92 312 0295812 with your city/town name and we'll confirm PostEx coverage within minutes." },
      ...
      { q: "Order tracking — how it works", a: "As soon as your order is packed and handed to PostEx courier (or DHL for international), you receive: (1) Email with PostEx/DHL tracking number and direct tracking link, (2) A WhatsApp update with your tracking details, (3) Tracking visible in your account under 'My Orders' and on our Track Order page. Tracking updates as your parcel moves: booked, picked up by PostEx, in transit, out for delivery, delivered. You can also track directly on the PostEx website with your tracking number, or message us on WhatsApp +92 312 0295812 and we'll check for you. For international DHL shipments, track on DHL.com with your tracking number. If tracking doesn't update for 24+ hours, contact us and we'll check with courier immediately." },
      { q: "What if I'm not home for delivery?", a: "PostEx courier will attempt delivery during business hours (usually 10am-6pm). If you're not available: (1) The PostEx rider calls your provided phone number to coordinate, (2) If no answer, rider leaves a delivery attempt notice with contact number, (3) To reschedule or request delivery to an alternate address (same city only), message us on WhatsApp +92 312 0295812 and we'll coordinate with PostEx for you, (4) PostEx holds the package at their local facility for 5 days for customer pickup. If delivery fails after 3 attempts or package isn't picked up within 5 days, it returns to our Karachi studio and you'll be contacted to arrange re-delivery (additional shipping charges may apply for re-delivery). To avoid delays: ensure your phone number is correct at checkout and keep phone accessible during delivery window." },
  ...
  payments: {
    ...
    faqs: [
      ...
      { q: "Cash on Delivery (COD) — how it works", a: "Cash on Delivery is available on all orders up to Rs. 25,000 to any address in Pakistan served by PostEx courier. Here's the process: (1) Place your order and select 'Cash on Delivery' at checkout, (2) You'll receive a verification call from our team within 2-4 hours to confirm your order details and delivery address (this prevents fake orders and courier costs), (3) Once verified, your order is prepared and shipped via PostEx, (4) the PostEx courier delivers to your address and you pay the exact order amount in cash to the rider, (5) the PostEx courier provides you an official receipt for payment. COD verification calls are made Monday-Saturday 10am-6pm PKT. If we cannot reach you within 24 hours, the order is placed on hold and you will receive an email or WhatsApp message asking you to contact us." },
      { q: "Are there COD fees or limits?", a: "COD is available FREE (no extra charges) on all orders from Rs. 500 to Rs. 25,000. Minimum order for COD: Rs. 500 (to cover courier costs). Maximum order for COD: Rs. 25,000 (this protects both customers and couriers from carrying large cash amounts). For orders exceeding Rs. 25,000, you can either: (1) Split into multiple smaller orders, (2) Pay 50% advance via bank transfer and pay remaining 50% COD, or (3) Wait for our online payment gateway to launch (coming soon) and pay full amount by card. COD is available to all cities and towns in Pakistan served by PostEx courier network." },
      ...
      { q: "Is Cash on Delivery safe?", a: "Yes, COD through PostEx is very safe for several reasons: (1) PostEx couriers are trained professionals employed by a reputable Pakistani logistics company, (2) You pay only after receiving and inspecting your package — don't accept if package appears tampered or damaged, (3) the PostEx rider provides an official receipt for your cash payment immediately, (4) You can record the package handover and cash payment for your records if desired, (5) Our verification call before dispatch ensures the order is genuine and prevents courier fraud. IMPORTANT: Only pay the exact order amount shown on your order confirmation email. If courier asks for a different amount, contact us immediately before paying. Never share card details or bank account info with courier riders — COD means cash payment only upon delivery." },
