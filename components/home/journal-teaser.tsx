...
const posts = [
  ...
  {
    title: "A capsule wardrobe in ten pieces",
    excerpt: "Ten versatile pieces that carry a Pakistani woman through every occasion — from everyday to formal.",
    tag: "Style Notes",
    href: "/journal/capsule-wardrobe-pakistani-women-10-pieces",
    image: "/blog/capsule-wardrobe-pakistani-women-10-pieces.webp",
    tone: ["#dcdccd", "#8c9b7e", "#3d4a36"] as [string, string, string],
    motif: "lattice" as const,
  },
  {
    title: "How to dress for an Eid dawat",
    excerpt: "Styling tips for Pakistani women — choosing the perfect ensemble for Eid celebrations.",
    tag: "Occasion",
    href: "/journal/how-to-dress-eid-dawat-pakistan",
    image: "/journal/how-to-dress-eid-dawat-pakistan.png",
